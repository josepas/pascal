...
begin
  ...
  writeln('Se generara un triangulo con los puntos (', p1.x, ', ', p1.y, '), (', p2.x, ', ', p2.y, ') y (', p3.x, ', ', p3.y, ')'); 
  ...
  writeln('La pendiente entre los puntos 1 y 2 es: ', m12:0:4);
  writeln('La pendiente entre los puntos 1 y 3 es: ', m13:0:4);
